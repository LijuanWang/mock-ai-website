        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <div className="max-w-sm">
            ...
            <p className="mt-3 text-sm text-gray-500">
              Building responsible AI that amplifies human potential and creates 
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} MAI Super Intelligence. All rights reserved.
            </p>
            <p className="text-xs text-gray-400">
              This site uses analytics and clarity-style insights to improve user experience and understand site usage patterns.
            </p>
          </div>
        </div>
      </div>
